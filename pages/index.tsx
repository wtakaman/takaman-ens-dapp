...
export default function Home() {
  ...
  */
  ...
  let ensMessage = "";
  if (ens) {
    ensMessage = `ENS resolved: <span style='color: greenyellow'>${ens}</span>`;
  } else {
    ensMessage = `ENS not found. Register <a href='https://app.ens.domains/' style='text-decoration: underline; color: greenyellow'>here</a>`
  }
